...
VSTABS_DIRECTIVE_BASE_COEFF = 0.95
VSTABS_DIRECTIVE_BOUNTY_COEFF = 0.938
VSTABS_DIRECTIVE_BONDS_COEFF = 0.933
IRM_BASE_COEFF = 0.9
...
GLD_DIRECTIVE_BASE_COEFF = 0.98
GLD_DIRECTIVE_BOUNTY_COEFF = 0.98
GLD_DIRECTIVE_BONDS_COEFF = 0.978
VENTS_BASE_COEFF = 5
VENTS_CATEGORY_COEFF = 6
VENTS_BOUNTY_COEFF = 7.5
VENTS_BONDS_COEFF = 8.5
VENTS_DIRECTIVE_COEFF = 2.5
BIA_COEFF = 5
FOOD_COEFF = 10
