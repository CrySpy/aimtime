...
vents_bloom = bloomFunc(acc/crewbonus(crew_member_level, commander_level, vents_coeff + other_crew_coeff), coeff/crewbonus(crew_member_level, commander_level, vents_coeff + other_crew_coeff), speed)
...
ax.plot(t, aimfunc(t, vents_bloom, aim_time/crewbonus(crew_member_level, commander_level, vents_coeff), acc/crewbonus(crew_member_level, commander_level, vents_coeff)), label='Vents', linewidth=1.25)
